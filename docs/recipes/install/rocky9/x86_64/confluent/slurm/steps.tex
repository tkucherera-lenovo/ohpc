...
In addition to the \OHPC{} and \Confluent{} package repositories, the {\em master} host also
...
% begin_ohpc_run
% ohpc_validation_newline
% ohpc_validation_comment Verify compute nodes deployment is done
% ohpc_validation_newline
