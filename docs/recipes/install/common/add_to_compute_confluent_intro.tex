...
[sms](*\#*) nodeshell compute dnf config-manager --add-repo=http://$sms_ip/$epel_repo_dir_confluent
[sms](*\#*) nodeshell compute "echo gpgcheck=0 >> /etc/yum.repos.d/${sms_ip}_"${epel_repo_dir_confluent//\//"_"}.repo
\end{lstlisting}
% end_ohpc_run
